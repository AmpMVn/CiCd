    ...
    spec:
      containers:
        ...
        - name: prod-rs-ms-ob-php
          image: gcr.io/GOOGLE_CLOUD_PROJECT/argo-prod-rentsoft-ms-ob-php-fpm-api:COMMIT_SHA
          env:
            - name: APP_ENV
              value: "prod"
            - name: APP_DEBUG
        ...
        - name: prod-rs-ms-ob-nginx
          image: gcr.io/GOOGLE_CLOUD_PROJECT/argo-prod-rentsoft-ms-ob-nginx-api:COMMIT_SHA
          ports:
            - containerPort: 80
          livenessProbe:
            failureThreshold: 3
